...
スクラムガイド@<fn>{001} では、スクラムマスターは「スクラムチームの進捗の妨げになるものを取り除くように働きかける」責任を負うと定められており、
さまざまな形でスクラムチーム、プロダクトオーナー、組織を支援する役割です。

しかし、このフレームワークはスクラムマスター自身の妨げを取り除くための明確なメカニズムを定義していません。
開発者はデイリースクラムでブロッカーを表明することができますが、基本的に多くの場合スクラムマスターはチームに一人であり自身の課題を
...
特に注意するべきは、単に「仲が良いだけ」で外部の顧客価値に向き合えていないチームを形成してしまう罠です。
...
課題の分類	典型的な症状・例	考えるべきこと・問い
----------------------------------------------------------------------
役割遂行@<br>{}　@<br>{}　@<br>{}　	・デイリースクラムが常に時間@<br>{}超過する@<br>{}・ふりかえりで具体的な改善@<br>{}アクションが決まらない	イベントの目的はチームに伝わっているか？@<br>{}自分のファシリテーションは適切か？@<br>{}　@<br>{}　
チーム関係@<br>{}　@<br>{}　@<br>{}　	・ふりかえりで本音の対話が出て@<br>{}こない@<br>{}・チームが内向きで、顧客への@<br>{}価値提供に関心が薄い	チームには本音で話せる心理的安全性が@<br>{}あるか？@<br>{}チーム共通の目的は明確か？@<br>{}　
組織・環境@<br>{}　@<br>{}　@<br>{}　	・ステークホルダーがスプリント@<br>{}レビューにこない@<br>{}・上層部からベロシティ向上の@<br>{}プレッシャーが強い	自分の課題はより大きな組織の問題の表れ@<br>{}ではないか？@<br>{}　@<br>{}　
自分自身@<br>{}　@<br>{}　@<br>{}　	・「自分の能力が足りない」と@<br>{}感じてしまう@<br>{}・成果が見えず、燃え尽きを@<br>{}感じる	自分自身の成功をどう定義しているか？@<br>{}誰からフィードバックを得られるか？@<br>{}　@<br>{}　
//}
...
より大きなシステム（チームや組織）を改善しようとする試みは、脆弱な土台の上に築かれることになり、その真正性を欠くことになります。
 ...
 * 悪い例（Tryのまま）：「リファインメントの準備をしっかりする」
 ** 抽象的で、いつ何をすれば良いのか不明確
 ** 実行したかどうかの判断基準が曖昧
 * 良い例（Actionに変換）：「毎週火曜の午後に1時間、カレンダーをブロックし、水曜のリファインメントに備えてバックログ上位5項目の事前確認と、明確化のための質問リスト作成を行う」
 ** 具体的な日時（毎週火曜午後）
 ** 観測可能な成果物（質問リスト）
 ** 自分が行動することが明確
...
しかし、それを構造化された形で書き出し（KPTA）、永続的なアーティファクト（Actionやバックログ項目）として外部化する事で、
...
//footnote[001][スクラムガイド： @<href>{https://scrumguides.org/docs/scrumguide/v2020/2020-Scrum-Guide-Japanese.pdf/} ]