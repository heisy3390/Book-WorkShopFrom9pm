...
=== 完璧主義が邪魔をする
コードを読む時、全てを完全に理解しようとする必要はありません。コードの多くが定型の記述であり、8割程度の理解で、該当のコードが何をしているか、理解することが可能だからです。そのため、コードを完璧に理解する必要はありません。
...
=== テンプレートを見つけ出す
 おなじみのフレームワークの規約や、デザインパターン（ファクトリー、ストラテジーなど）は、実装の詳細を読まずとも意図を推測できる強力な手がかりとなります。@<br>{}
